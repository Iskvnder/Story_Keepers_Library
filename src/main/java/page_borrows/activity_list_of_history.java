...
public class activity_list_of_history extends Configs implements Initializable {
    ...
    private ObservableList<BorrowsModel> getData() {
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("select * from history_of_borrows");
