...
public class activity_list_book_by_genre extends Configs implements Initializable {
    ...
    private ObservableList<BooksModel> getData() {
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("select * from books where genre_id = " + activity_book_by_genre.genreIdString);
